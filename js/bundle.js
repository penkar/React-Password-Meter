...
var App = module.exports = React.createClass({displayName: "exports",
	...
	render: function(){
		...
		for(var i in variable){
			array.push(React.createElement("div", null, i));
		}
		return(
			React.createElement("div", null, 
				React.createElement("input", {id: "password", value: variable.length}), 
				array
			)
		)
	}
