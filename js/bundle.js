	...
	render: function(){
		return (React.createElement("table", null, 
			...
			React.createElement("tr", null, 
				...
				React.createElement("td", null, React.createElement("input", {id: "length", onChange: Actions.length}))
			), 
			React.createElement("tr", null, 
				React.createElement("td", null, "Required Letter Count"), 
				React.createElement("td", null, React.createElement("input", {id: "letters", onChange: Actions.letters}))
			), 
			React.createElement("tr", null, 
				React.createElement("td", null, "Required Number Count"), 
				React.createElement("td", null, React.createElement("input", {id: "numbers", onChange: Actions.numbers}))
			), 
			React.createElement("tr", null, 
				React.createElement("td", null, "Special Characters"), 
				React.createElement("td", null, React.createElement("input", {id: "specialChar", onChange: Actions.specialChar}))
			), 
			React.createElement("tr", null, 
				React.createElement("td", null, "Capital Letters"), 
				React.createElement("td", null, React.createElement("input", {id: "capLetters", onChange: Actions.capLetters}))
			)
			)
		))
	}
...
},{"reflux":5}],5:[function(require,module,exports){
module.exports = require('./src');

},{"./src":19}],6:[function(require,module,exports){
'use strict';
...
},{"./joins":20,"./utils":24}],11:[function(require,module,exports){
var _ = require('./utils'),
...
},{"./ListenerMethods":10,"./utils":24}],12:[function(require,module,exports){
var _ = require('./utils');
...
},{"./index":19,"./utils":24}],16:[function(require,module,exports){
var Reflux = require('./index'),
  _ = require('./utils');
...
},{"./index":19,"./utils":24}],17:[function(require,module,exports){
var _ = require('./utils'),
...
},{"./Keep":9,"./index":19,"./utils":24}],18:[function(require,module,exports){
var _ = require('./utils'),
    Reflux = require('./index'),
    Keep = require('./Keep'),
    mixer = require('./mixer'),
...
},{"./Keep":9,"./bindMethods":14,"./index":19,"./mixer":23,"./utils":24}],19:[function(require,module,exports){
...
},{"./ActionMethods":8,"./Keep":9,"./ListenerMethods":10,"./ListenerMixin":11,"./PublisherMethods":12,"./StoreMethods":13,"./connect":15,"./connectFilter":16,"./createAction":17,"./createStore":18,"./joins":20,"./listenTo":21,"./listenToMany":22,"./utils":24}],20:[function(require,module,exports){
/**
...
},{"./createStore":18,"./utils":24}],21:[function(require,module,exports){
var Reflux = require('./index');
...
},{"./index":19}],22:[function(require,module,exports){
var Reflux = require('./index');
...
},{"./index":19}],23:[function(require,module,exports){
var _ = require('./utils');
