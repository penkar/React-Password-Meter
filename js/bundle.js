      ...
      for(var j = 0; j < specials.length; j++){
		...
		return(
			React.createElement("div", {className: "main"}, 
				React.createElement("ul", {className: "error"}, 
					errors
				), 
...
var Header = module.exports = React.createClass({displayName: "exports",
  render: function(){
    return (
      React.createElement("div", {id: "header", className: "clearfix"}, "5 Paramater React Password Strength RegEx")
    )
  }
})
...
var PassForm = module.exports = React.createClass({displayName: "exports",
	...
	render: function(){
		...
		for(var i in state){
			var disp = state[i];
			if(disp){
				errors.push(React.createElement("div", {className: "error"}, i, " should be an integer"))
			}
		}
		return (
		React.createElement("div", {className: "main"}, 
			React.createElement("table", null, 
				...
				React.createElement("tr", null, 
					...
					React.createElement("td", null, React.createElement("input", {id: "specialChar", onChange: this.change2}))
				), 
				React.createElement("tr", null, 
